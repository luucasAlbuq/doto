...
/**
 * Para rodar os testes � necess�rio ter APENAS profissional do tipo m�dico
...
//		boolean medicoSelecionado = mSolo.isSpinnerTextSelected(0, "M�dico");
//		assertEquals("M�dico selecionado", true, medicoSelecionado);
//		mSolo.sleep(10);
//
//		// Seleciona Especialidade - Cardiologista
//		mSolo.pressSpinnerItem(1, 1);
